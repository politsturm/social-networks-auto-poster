...
if (!class_exists("nxs_snapClassLN")) {
    class nxs_snapClassLN extends nxs_snapClassNT
    {
        public $ntInfo = array('code'=>'LN', 'lcode'=>'ln', 'name'=>'Line', 'defNName'=>'uName', 'tstReq' => false, 'instrURL'=>'https://www.nextscripts.com/instructions/line-auto-poster-setup-installation/');
...
if (!function_exists("nxs_doPublishToLN")) {
    function nxs_doPublishToLN($postID, $options)
    {
        if (!is_array($options)) {
            $options = maybe_unserialize(get_post_meta($postID, $options, true));
        }
        $cl = new nxs_snapClassLN();
