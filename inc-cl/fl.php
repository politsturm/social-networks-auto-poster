...
if (!class_exists("nxs_snapClassFL")) {
    class nxs_snapClassFL extends nxs_snapClassNT
    {
        public $ntInfo = array('code'=>'FL', 'lcode'=>'fl', 'name'=>'Flickr', 'defNName'=>'', 'tstReq' => true, 'instrURL'=>'https://www.nextscripts.com/instructions/flickr-social-networks-auto-poster-setup-installation/');
        //#### Update
      ...
      break;
        ...
        {
            $defO = array('nName'=>'', 'do'=>'1', 'appKey'=>'', 'appSec'=>'', 'defImg'=>'', 'inclTags'=>1, 'msgFormat'=>"%EXCERPT% \r\n\r\n%URL%", 'msgTFormat'=>"%TITLE%", 'imgSize'=>'original', 'setID'=>'', 'userURL'=>'');
        ...
        public function accTab($ii, $options, $isNew=false)
        {
            ...
            $ntInfo = $this->ntInfo;
            $nt = $ntInfo['lcode'];
            $this->elemKeySecret($ii, 'Consumer Key', 'Consumer Secret', $options['appKey'], $options['appSec'], 'appKey', 'appSec', 'https://www.flickr.com/services/apps/'); ?>    
