...
if (!class_exists("nxs_snapClassDI")) {
    class nxs_snapClassDI extends nxs_snapClassNT
    {
        public $ntInfo = array('code'=>'DI', 'lcode'=>'di', 'name'=>'Diigo', 'defNName'=>'uName', 'tstReq' => false, 'instrURL'=>'https://www.nextscripts.com/setup-installation-diigo-social-networks-auto-poster-wordpress/');
      ...
      break;
        ...
        {
            $defO = array('nName'=>'', 'do'=>'1', 'uName'=>'', 'uPass'=>'',  'apiKey'=>'', 'inclTags'=>'1', 'msgTFormat'=>'%TITLE%', 'msgFormat'=>"%EXCERPT%");
        ...
        {
            $ntInfo = $this->ntInfo;
            $nt = $ntInfo['lcode']; ?><div id="altFormat" style="">
    ...
    </div><?php $this->elemUserPass($ii, $options['uName'], $options['uPass']);
            $this->elemTitleFormat($ii, 'Message Title Format', 'msgTFormat', $options['msgTFormat']);
