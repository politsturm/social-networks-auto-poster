...
if (!class_exists("nxs_snapClassST")) {
    class nxs_snapClassST extends nxs_snapClassNT
    {
        public $ntInfo = array('code'=>'ST', 'lcode'=>'st', 'name'=>'SETT', 'defNName'=>'uName', 'tstReq' => false, 'instrURL'=>'https://www.nextscripts.com/instructions/sett-social-networks-auto-poster-setup-installation/');
      ...
      break;
        ...
        {
            $defO = array('nName'=>'', 'do'=>'1', 'uName'=>'', 'uPass'=>'', 'mgzURL'=>'',  'msgTFormat'=>'%TITLE%', 'msgFormat'=>"%FULLTEXT% \r\n\r\n<a href=".'"%URL%"'.">Source</a>");
