...
if (!class_exists("nxs_class_SNAP_LN")) {
    class nxs_class_SNAP_LN
    {
        public $ntCode = 'LN';
        public $ntLCode = 'ln';
        ...
        'originalContentUrl'=>'https://res.cloudinary.com/nextscripts/image/fetch/c_scale,w_1024/'.$imgURL, 'previewImageUrl'=>'https://res.cloudinary.com/nextscripts/image/fetch/c_scale,w_240/'.$imgURL))));
                ...
                $hdrsArr = $this->nxs_getHeaders('https://api.line.me', true);
                $hdrsArr['Authorization']='Bearer '.$options['botTkn'];
            ...
            if (is_array($resp) && empty($resp)) {
                ...
                $badOut['Error'] .= 'Something went wrong - '.print_r($ret, true).' | '.print_r($flds, true);
            }
            return $badOut;
        }
    }
