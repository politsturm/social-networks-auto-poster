...
if (!class_exists("nxs_snapClassIP")) {
    class nxs_snapClassIP extends nxs_snapClassNT
    {
        public $ntInfo = array('code'=>'IP', 'lcode'=>'ip', 'name'=>'Instapaper', 'defNName'=>'uName', 'tstReq' => false, 'instrURL'=>'https://www.nextscripts.com/setup-installation-instapaper-social-networks-auto-poster-wordpress/');
      ...
      break;
        ...
        {
            $defO = array('nName'=>'', 'do'=>'1', 'uName'=>'', 'uPass'=>'', 'msgTFormat'=>'%TITLE%', 'msgFormat'=>"%FULLTEXT%");
