...
if (!class_exists("nxs_snapClassDA")) {
    class nxs_snapClassDA extends nxs_snapClassNT
    {
        public $ntInfo = array('code'=>'DA', 'lcode'=>'da', 'name'=>'deviantART (!)', 'defNName'=>'uName', 'tstReq' => false, 'instrURL'=>'https://www.nextscripts.com/setup-installation-deviantart-social-networks-auto-poster-wordpress/');
